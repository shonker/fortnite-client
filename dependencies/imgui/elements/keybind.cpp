...
bool renderer::imgui::elements::functions::hotkey(const char* label, int* k)
{
    ...
    if (g.ActiveId == id)
        ...
        window->DrawList->AddText(NULL, 13, bb.Min + ImVec2(18, 15), ImColor(211, 211, 211, 160 + int(Active * 91.f)), ICON_FA_LAYER_GROUP);
...
bool renderer::imgui::elements::functions::hotkey_stretched(const char* label, int* k)
{
    ...
    window->DrawList->AddText(NULL, 7, bb.Min + ImVec2(18 + 120, 13), ImColor(211, 211, 211, 160 + int(Active * 91.f)), ICON_FA_KEYBOARD);
