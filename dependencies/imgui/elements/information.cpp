...
void renderer::imgui::elements::functions::information(const char* label, const char* desc, float p_data, const char* format)
{
    ...
    window->DrawList->AddText(NULL, 15, bb.Min + ImVec2(328 - ImGui::CalcTextSize(value_buf).x - 25, 57 / 2 - ImGui::CalcTextSize(ICON_FA_RADAR).y / 2), ImColor(211, 211, 211, 211), ICON_FA_RADAR);
